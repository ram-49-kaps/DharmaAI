...
pattern_send = r'  const handleSend = async \(text, attachments = \[\]\) => \{.*?\n  \};\n'
content = re.sub(pattern_send, new_handle_send + '\n', content, flags=re.DOTALL)

pattern_edit = r'  const handleEditMessage = async \(index, newContent\) => \{.*?\n  \};\n'
content = re.sub(pattern_edit, new_handle_edit + '\n', content, flags=re.DOTALL)

with open("src/App.js", "w") as f:
    f.write(content)
print("Updated handleSend and handleEditMessage")
