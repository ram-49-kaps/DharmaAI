...
PROMPT = ChatPromptTemplate.from_messages([
    ("system",
     SCOPE_GUARD + """\n\nYou are Prakarna AI — a legal educator specialising in Indian legislation, constitutional provisions, and the Indian Knowledge System (IKS).
...
def run_statute_chain(message: str, level: str = None, stream: bool = False, model_id: str = None):
    try:
